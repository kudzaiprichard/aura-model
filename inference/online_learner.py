...
from inference.registry import ModelRegistry, default_models_root
from inference.schema import OnlineLearningResult, ValidationError
from inference.validation import validate_training_batch
...
# we cap iterations per call to prevent runaway partial_fit loops.
DEFAULT_MAX_ITER_PER_CALL = 5
